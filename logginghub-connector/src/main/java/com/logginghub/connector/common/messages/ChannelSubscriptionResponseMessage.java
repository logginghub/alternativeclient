...
public class ChannelSubscriptionResponseMessage extends BaseRequestResponseMessage implements SerialisableObject {
    ...
    public ChannelSubscriptionResponseMessage(int requestID, boolean subscribe, String reason, boolean success, String... channels) {
        super();
    ...
    public ChannelSubscriptionResponseMessage() {}
