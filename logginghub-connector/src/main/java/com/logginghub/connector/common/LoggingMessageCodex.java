...
import com.logginghub.connector.common.messages.CompressedBlock;
...
//                    NewSubscriptionRequestMessage message = new NewSubscriptionRequestMessage(LogEventCodex.decodeStringArray(buffer));
//                    return message;
//                }
//                case SubscribeResponse: {
//                    NewSubscriptionResponseMessage message = new NewSubscriptionResponseMessage(LogEventCodex.decodeStringArray(buffer));
//                    return message;
//                }
//                case UnsubscribeRequest: {
//                    NewUnsubscribeRequestMessage message = new NewUnsubscribeRequestMessage(LogEventCodex.decodeStringArray(buffer));
//                    return message;
//                }
//                case UnsubscribeResponse: {
//                    NewUnsubscribeResponseMessage message = new NewUnsubscribeResponseMessage(LogEventCodex.decodeStringArray(buffer));
//                    return message;
//                }
                case Encrypted: {
...
//            SerialisableObjectWrapper serialisableObjectWrapper = (SerialisableObjectWrapper) message;
//            SerialisableObject serialisableObject = serialisableObjectWrapper.getSerialisableObject();
...
//    public void encode(ExpandingByteBuffer expandingBuffer, NewSubscriptionRequestMessage message) {
...
//    }
//
//    public void encode(ExpandingByteBuffer expandingBuffer, NewSubscriptionResponseMessage message) {
...
//    }
//
//    public void encode(ExpandingByteBuffer expandingBuffer, NewUnsubscribeResponseMessage message) {
//        expandingBuffer.put(LoggingMessageCodex.SubscribeResponse);
//        LogEventCodex.encodeStringArray(expandingBuffer, message.getChannels());
//    }
...
//    public void encode(ExpandingByteBuffer expandingBuffer, TelemetryStack telemetryStack, EnumSet<Flags> flags) {
//        logger.finest("Encoding event into buffer '{}'", expandingBuffer);
//        int position = expandingBuffer.position();
