...
public class LogEventComparer
{
    ...
    {
        TestCase.assertEquals(description, a.getLocalCreationTimeMillis(), b.getLocalCreationTimeMillis());
    ...
    {
        TestCase.assertEquals(expected.getMillis(), actual.getLocalCreationTimeMillis());
