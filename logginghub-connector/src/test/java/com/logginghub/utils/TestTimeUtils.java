...
public class TestTimeUtils {
    ...
    @Test public void testFormatIntervalMilliseconds() throws Exception {
        ...
        assertThat(TimeUtils.formatIntervalMilliseconds(TimeUtils.seconds(1)), is("1.00 second"));
        assertThat(TimeUtils.formatIntervalMilliseconds(TimeUtils.seconds(2)), is("2.00 seconds"));
